...
import models.ProductionMaterialsPriceModelList;
import models.RawMaterialsPriceModelList;
import models.RawMaterialsPricesModel;
...
//                                    rmpm.getPricesTable()[j][i] = Integer.valueOf(cell.getContents());
            ...
            new PopUpInfoView("Nie załadowano tablic cenowych");
        }
    }
...
//                    model.getModelListData()[j][i] = cell.getContents();
            ...
            e.printStackTrace();
            new PopUpInfoView("Nie udało się załadować cen produkcji w Prices Table");
        }
    }
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            if (extension != null) {
                if (extension.equals(PricesTable.Utils.xls)) {
                    ...
                    new PopUpInfoView("Ustawiono nowe źródło cen surowców");
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            if (extension != null) {
                if (extension.equals(PricesTable.Utils.xls)) {
                    ...
                    new PopUpInfoView("Ustawiono nowe źródło cen produkcji");
...
//            Each sheet by class is automaticcly added to RMPML
            ...
            new PopUpInfoView("Nie udało się załadować modeli surowców");
        }
    }
